  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row items-center justify-between  md:px-40 sm:px-20 px-8 z-0">
        <div className="flex flex-col md:w-1/2 space-y-4 ">
          <div className="flex flex-col space-y-4 w-full">
            <h1 className="text-4xl font-inter font-semibold text-justify select-none cursor-default outline-none">
              Turning Your Dream Home into Reality
            </h1>
            <p className=" text-base text-justify  md:text-lg select-none cursor-default outline-none font-inter font-light">
      ...
      <div className="flex flex-col ">
        <h1 className="text-6xl text-center  mt-10  from-accent-content">
          Explore Our Project
        </h1>
        <Carousel />
      </div>
